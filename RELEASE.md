...
- `PlexCoverManager-v0.0.4.exe`
- `PlexCoverManager-v0.0.4-portable.exe`
...
4. Tag `v0.0.4` eintragen und erstellen lassen.
5. Release title: `Plex Cover Manager v0.0.4`
6. Beide Dateien aus `dist/` als Assets hochladen.
7. Release notes kurz halten, z.B.:

```text
Plex Cover Manager v0.0.4
...
gh release create v0.0.4 `
  .\dist\PlexCoverManager-v0.0.4.exe `
  .\dist\PlexCoverManager-v0.0.4-portable.exe `
  --title "Plex Cover Manager v0.0.4" `
  --notes "Plex Cover Manager v0.0.4"
```
