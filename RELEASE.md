...
4. Tag `v0.0.3` eintragen und erstellen lassen.
5. Release title: `Plex Cover Manager v0.0.3`
6. Beide Dateien aus `dist/` als Assets hochladen.
7. Release notes kurz halten, z.B.:

```text
Plex Cover Manager v0.0.3
...
gh release create v0.0.3 `
  .\dist\PlexCoverManager-v0.0.3.exe `
  .\dist\PlexCoverManager-v0.0.3-portable.exe `
  --title "Plex Cover Manager v0.0.3" `
  --notes "Plex Cover Manager v0.0.3"
```
