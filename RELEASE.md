...
- `PlexCoverManager-v0.3.0-linux-amd64` (wenn der Linux-Build ausgefuehrt wurde)
...
4. Tag `v0.3.0` eintragen und erstellen lassen.
5. Release title: `Plex Cover Manager v0.3.0`
6. Beide Dateien aus `dist/` als Assets hochladen.
7. Release notes kurz halten, z.B.:

```text
Plex Cover Manager v0.3.0
...
gh release create v0.3.0 `
  .\dist\PlexCoverManager-v0.3.0.exe `
  .\dist\PlexCoverManager-v0.3.0-portable.exe `
  --title "Plex Cover Manager v0.3.0" `
  --notes "Plex Cover Manager v0.3.0"
```
